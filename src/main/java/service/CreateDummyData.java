...
public class CreateDummyData {
    public static void create() {
        ...
        areaList.add(new Area("W01", "T0 Montagepark", "Automatisierte Montage von T0 Komponenten", Floor.EG, 643.00,
                "Sascha Seepferd"));
        areaList.add(new Area("W01", "T1 Assembly", "Diverse Montage und Gravuren auf Ebauches", Floor.UG1, 200.00,
                "Nina Nielpferd"));
        areaList.add(
                new Area("W02", "Glaspresse", "Einpressen von Lunetten und kleinen Schlafpillen", Floor.OG3, 250.00,
                        "Leo Löwe"));
        areaList.add(new Area("W06", "Optische Kontrolle", "Auschecken der gesamten Mouvements Monté", Floor.OG1, 5.00,
                "Emma Elefant"));
        ...
        processCellList.add(
                new Laser(100066, "Laser A", manufacturers.get(4), customers.get(3), MachineType.HANDARBEITSPLATZ,
                        "images/LightsaberAnakin.jpg", areas.get(5), 5600));
        processCellList.add(

...
// ObservableList<Enterprise> enterprises =
// FXCollections.observableList(enterpriseList);

// // Serialize test data
// SerializationService.serializeEnterpriseData(enterprises, FILE_NAME);

// // Deserialize test data
// ObservableList<Enterprise> deserializedEnterprises =
// SerializationService.deSerializeEnterpriseDatao(FILE_NAME);
...
// Assertions.assertEquals(original.getId(), deserialized.getId(), "ID does not
// match.");
// Assertions.assertEquals(original.getName(), deserialized.getName(), "Name
// does not match.");
// }
// }
// }
